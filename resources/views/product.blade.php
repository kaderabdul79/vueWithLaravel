                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                @if (Route::has('login'))
                                 @auth
                                    <li class="nav-item">
                                        <a href="{{ url('/home') }}"  data-scroll-nav="0">Cart</a>
                                    </li>
                                    @else
                                        <a href="{{ route('login') }}"  data-scroll-nav="0">Log in</a>
                                    <li class="nav-item">
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"  data-scroll-nav="0">Register</a>
                                        @endif
                                    </li>
                                    @endauth
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="{{$product->image_name}}" height="320px" alt="Product"></a>
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                ...
                                                <hr/>
                                                <button class="btn btn-warning text-center">Add To Cart</button>
                                            </div>
